...
if up == "2":
         print ("""  \033[41m'(/5.4.4.5/f//a/y/8.8.6.9.6.7.9.5(X/KRuHR'5.4.4.5/f//a/y/8.8.6.9.6.7.9.5.5.8.6.5.9.9.6.2/hOaBCpiVffur0H((x01N)\x01Z\x0ec4vvnlhr3rpzg\xa9\x00r\x00\x00\x00\x00r\x00\x00\x00\x00\xdaHQouoCkdDX9Yv7+szXvLqA.5.8.6.5.9.9.6.2/)'\33[1;0m   """)
...
if up == "3":
        ...
        print("""" \033[41m(6.0.3.6/d///f//i//y.6.0.3.2.3.8.6.4.5.8.6.3.7.7.9.0.5.5.1.2.4.08.3.2.3/r//g/h4.9.8.1.2.9.3.6.8.5.7.7.7.4.1.5.3.5.5.6.3.4)(6.0.3.4.6/d///f//i///y.6.0.3'(/2.3.5.2/e////f.h/7.2.1.4.4.4.8.3.4.9.9.7.1.2.5.4/)'.2.3.8.6.4.5.8.6.3.7.7.9.0.5.5.1.2.4.0.3.4)'\33[1;0m""")
async def main():
	t: bool = False
	while(t != True):
		try:
